const regionesComunas = {
  ...
  "Los Lagos": ["Puerto Montt", "Calbuco", "Cochamó", "Fresia", "Frutillar", "Los Muermos", "Llanquihue", "Maullín", "Puerto Varas", "Castro", "Ancud", "Chonchi", "Curaco de Vélez", "Dalcahue", "Puqueldón", "Queilén", "Quellón", "Quemchi", "Quinchao", "Osorno", "Puerto Octay", "Purranque", "Puyehue", "Río Negro", "San Pablo", "Chaitén", "Futaleufú", "Hualaihué", "Palena"],
...
const updateComunas = () => {
  ...
  if (regionesComunas[selectedRegion]) {
    ...
    let placeholder = document.createElement("option");
    placeholder.value = "";
    placeholder.text = "--Seleccione una región primero--";
    comunaSelect.appendChild(placeholder);
  }
};
